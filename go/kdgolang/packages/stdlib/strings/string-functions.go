...
func main() {
    ...
    //Note that these are all functions from package, not methods on the string object itself.
    //This means that we need pass the string in question as the first argument to the function.
